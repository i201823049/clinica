...
public class MenuSuperAdmin extends JDialog implements MouseListener {
	...
	public MenuSuperAdmin() {
		...
		lblMantenimiento.setIcon(new ImageIcon(MenuSuperAdmin.class.getResource("/icons/1287509 - tools.png")));
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(MenuSuperAdmin.class.getResource("/icons/1287532 - chart.png")));
		...
		label_1 = new JLabel("");
		label_1.setIcon(new ImageIcon(MenuSuperAdmin.class.getResource("/icons/1287525 - gear.png")));
